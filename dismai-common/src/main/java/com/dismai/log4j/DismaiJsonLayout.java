...
@Plugin(name = "DismaiJsonLayout", category = Node.CATEGORY, elementType = Layout.ELEMENT_TYPE, printObject = true)
public final class DismaiJsonLayout extends BaseJsonLayout {

    private static final String JSON_ARRAY_START = "[";
    private static final String JSON_ARRAY_END = "]";
    private static final String MIME_TYPE = "application/json";

    private DismaiJsonLayout(Configuration config, boolean locationInfo, boolean properties,
     ...
     */
    @PluginFactory
    public static DismaiJsonLayout newLayout(
        ...
        return new DismaiJsonLayout(config, locationInfo, properties, threadContextAsList,
     ...
     * 创建默认实例（用于测试）
     */
    public static DismaiJsonLayout defaultLayout() {
        return new DismaiJsonLayout(new DefaultConfiguration(), false, false, false,
