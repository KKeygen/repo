...
import com.dismai.conf.RequestTemporaryWrapper;
...
import com.dismai.pro.limit.RateLimiter;
import com.dismai.pro.limit.RateLimiterProperty;
import com.dismai.property.GatewayProperty;
import com.dismai.service.ApiRestrictService;
import com.dismai.service.ChannelDataService;
import com.dismai.service.TokenService;
import com.dismai.threadlocal.BaseParameterHolder;
import com.dismai.util.RsaSignTool;
import com.dismai.util.RsaTool;
...
import static com.dismai.constant.Constant.TRACE_ID;
import static com.dismai.constant.GatewayConstant.BUSINESS_BODY;
import static com.dismai.constant.GatewayConstant.CODE;
import static com.dismai.constant.GatewayConstant.ENCRYPT;
import static com.dismai.constant.GatewayConstant.NO_VERIFY;
import static com.dismai.constant.GatewayConstant.REQUEST_BODY;
import static com.dismai.constant.GatewayConstant.TOKEN;
import static com.dismai.constant.GatewayConstant.USER_ID;
import static com.dismai.constant.GatewayConstant.V2;
import static com.dismai.constant.GatewayConstant.VERIFY_VALUE;
...
public class RequestValidationFilter implements GlobalFilter, Ordered {
    ...
    private Map<String,String> doExecute(String originalBody,ServerWebExchange exchange){
        ...
        if ((!allowNormalAccess) && (VERIFY_VALUE.equals(noVerify))) {
            throw new DismaiFrameException(BaseCode.ONLY_SIGNATURE_ACCESS_IS_ALLOWED);
        }
