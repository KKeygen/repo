...
import com.dismai.dto.DepthRuleDto;
import com.dismai.dto.DepthRuleStatusDto;
import com.dismai.dto.DepthRuleUpdateDto;
import com.dismai.entity.DepthRule;
import com.dismai.enums.BaseCode;
import com.dismai.enums.RuleStatus;
import com.dismai.exception.DismaiFrameException;
import com.dismai.mapper.DepthRuleMapper;
import com.dismai.util.DateUtils;
import com.dismai.util.StringUtil;
import com.dismai.vo.DepthRuleVo;
    ...
    public void check(String startTimeWindow, String endTimeWindow){
        ...
        for (final DepthRule depthRule : depthRules) {
            ...
            if (checkStartLimitTimeResult || checkEndLimitTimeResult) {
                throw new DismaiFrameException(BaseCode.API_RULE_TIME_WINDOW_INTERSECT);
            }
        }
    }
