...
import com.dismai.RedisStreamHandler;
import com.dismai.RedisStreamListener;
import com.dismai.RedisStreamPushHandler;
import com.dismai.constant.RedisStreamConstant;
...
public class RedisStreamAutoConfig {
    ...
    public void checkConsumerType(String consumerType){
        if ((!RedisStreamConstant.GROUP.equals(consumerType)) && (!RedisStreamConstant.BROADCAST.equals(consumerType))) {
            throw new DismaiFrameException(BaseCode.REDIS_STREAM_CONSUMER_TYPE_NOT_EXIST);
        }
    }
}
